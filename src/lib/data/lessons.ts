...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    title: "Huruf R dan U",
    description:
      "Tambah huruf R (jari telunjuk kiri) dan U (jari telunjuk kanan)",
    icon: "🚀",
    keys: ["r", "u"],
    words: [
      "rule",
  ...
  },
  {
    ...
    title: "Huruf G dan H",
    description:
      "Huruf di tengah keyboard: G (telunjuk kiri) dan H (telunjuk kanan)",
    icon: "🎯",
    keys: ["g", "h"],
    words: [
      "high",
    ...
    sentences: [
      ...
      "ghost graph gather fight",
      "fight high right light",
      "graph gather sight ghost",
    ],
    unlockScore: 12,
  },
  {
  ...
  },
  {
    ...
    sentences: ["1 2 3 4 5", "12 34 51 23", "45 12 34 51", "23 45 12 34"],
    unlockScore: 24,
  },
  {
    id: 12,
